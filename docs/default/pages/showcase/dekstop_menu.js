// pages/pages/showcase/react-srv-hydrate-DekstopMenu.jsx
...
function DesktopMenu() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("header", { style: { maxWidth: "600px" }, className: "disable-mobile", children: /* @__PURE__ */ jsxs("menu", { children: [
...
if (!globalThis.__REACT_SRV_HYDRATED__) {
  ...
  hydrateRoot(
    root,
    React.createElement(DesktopMenu, globalThis.__INITIAL_PROPS__ || {})
  );
}
