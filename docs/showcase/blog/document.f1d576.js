...
function Document({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsx("title", { children: "Showcase - Blog" }),
      ...
      /* @__PURE__ */ jsx("link", { rel: "stylesheet", href: `/res/theme.blog.min.css` }),
      /* @__PURE__ */ jsx("link", { rel: "stylesheet", href: `/${PUB_SUBDOMAIN}/res/theme.blog.min.css` })
    ] }),
