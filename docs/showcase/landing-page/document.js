...
function Document({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsx("link", { rel: "stylesheet", href: `/showcase/landing-page/custom.css` }),
      /* @__PURE__ */ jsx("link", { rel: "stylesheet", href: `/${PUB_SUBDOMAIN}/showcase/landing-page/custom.css` })
    ] }),
