import{a as St}from"./chunk-E42SUDRF.js";import{a as Nt}from"./chunk-OJJZ7I35.js";import{a as Mt}from"./chunk-6GSCAXFL.js";import{a as kt}from"./chunk-VAA7G7I3.js";import{a as Dt}from"./chunk-5FO5LKGV.js";import{a as $t}from"./chunk-BFLHTRDP.js";import{a as Ct}from"./chunk-KVSCSCQE.js";import{a as xt}from"./chunk-ASN7Q573.js";import{a as yt}from"./chunk-M6F2RLSF.js";import{a as wt}from"./chunk-KT2LLLXB.js";import{a as Lt}from"./chunk-IZYG7KBP.js";import{b as t}from"./chunk-GL7QZU6Z.js";import{a as Se}from"./chunk-7AZBNJU6.js";import{a as ft}from"./chunk-7J4MAJXS.js";import{useEffect as Yt,useState as Tt}from"https://esm.sh/react@19.2.0";import{useState as qt,useEffect as Ft}from"https://esm.sh/react@19.2.0";function D(){let[e,o]=qt(void 0);return Ft(()=>{if(typeof window<"u"){let B=window.location.pathname.includes(Se)?Se:"";o(B)}},[]),e}import{jsx as d,jsxs as C}from"https://esm.sh/react@19.2.0/jsx-runtime";function $e({theme:e}){let o=D();return C(c,{theme:e,children:[C("section",{className:"row",children:[C("div",{children:[C("p",{children:["Two types of buttons styles are supported: standard and outlined (for ",d("code",{children:"reset"})," type buttons)."]}),C("p",{children:[d("button",{children:"Button"}),d("button",{type:"reset",children:"Button"})]})]}),d("div",{children:d(t,{lang:"xml",children:`<button>Button</button>
<button type="reset">
  Button
...
</p>`})})]})]})}import{jsx as g,jsxs as te}from"https://esm.sh/react@19.2.0/jsx-runtime";function De({theme:e}){return te(c,{theme:e,children:[te("section",{className:"row",children:[te("div",{children:[te("p",{children:["Typography is based purely on ",g("a",{href:"https://en.wikipedia.org/wiki/CSS#CSS_3",target:"_blank",children:"CSS3"}),", meaning it can handle everything from basic paragraphs:"]}),g("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."})]}),g("div",{children:g(t,{lang:"xml",children:`<p>
...
</blockquote>`})})]})]})}import{jsx as de,jsxs as Ne}from"https://esm.sh/react@19.2.0/jsx-runtime";function Be({theme:e}){return de(c,{theme:e,children:de("section",{children:Ne("div",{className:"row",children:[Ne("div",{children:[de("p",{children:"Code can be displayed both inline as well as part of a stand alone code block."}),Ne("p",{children:["Inline code ",de("code",{children:"console.log('abc')"})]}),Ne("p",{children:["Keyboard shortcut ",de("kbd",{children:"Ctrl + S"})]}),Ne("figure",{children:[de(t,{lang:"xml",children:"console.log('abc')"}),de("figcaption",{children:"Code block"})]}),Ne("p",{children:["The theme doesn't handle syntax highlighting out of the box. That can be handled separately, by using a system such as ",de("a",{href:"http://hilite.me/",target:"_blank",children:"hilite.me"})," or ",de("a",{href:"https://highlightjs.org/",target:"_blank",children:"higlightjs.org"}),"."]})]}),de("div",{children:de(t,{lang:"xml",children:`<p>
...
<pre>
  <code>....</code>
</pre>`})})]})})})}import{jsx as se,jsxs as he}from"https://esm.sh/react@19.2.0/jsx-runtime";function qe({theme:e}){return he(c,{theme:e,children:[he("section",{className:"row",children:[he("div",{children:[se("p",{children:"Figures can contain a single image and an associated caption."}),he("figure",{children:[se("img",{width:"640",height:"480",src:"https://picsum.photos/id/16/640/480",alt:"ssample image "}),se("figcaption",{children:"Sample caption"})]})]}),se("div",{children:se(t,{lang:"xml",children:`<figure>
  <img 
    width="640" 
    height="480" 
    src="..." 
...
`})})]})})}import{jsx as x,jsxs as R}from"https://esm.sh/react@19.2.0/jsx-runtime";function Ee({theme:e}){let o=D();return R(c,{theme:e,children:[R("section",{className:"row",children:[R("div",{children:[x("p",{children:"The summary and details html tag is used to present a short piece of information that can be expanded to offer more insights."}),R("details",{children:[x("summary",{children:"Info"}),x("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."})]}),R("details",{children:[x("summary",{children:"More info Info"}),x("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."})]})]}),x("div",{children:x(t,{lang:"xml",children:`<details>
  <summary>Summary</summary>
  <p>Details</p>
</details>

<details>...</details>`})})]}),R("section",{className:"row",children:[R("div",{children:[R("p",{children:["This basic summary can be placed inside an ",x("code",{children:"article"})," and combined with the ",x("code",{children:"primary"}),", ",x("code",{children:"success"})," or ",x("code",{children:"error"}),", etc classes to form a more visually appealing element."]}),x("article",{children:R("details",{open:!0,children:[x("summary",{children:"Note"}),x("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."})]})}),x("article",{className:"primary",children:R("details",{children:[x("summary",{children:"Info"}),R("p",{children:["Larn more ",x("a",{href:"",children:"here"})]})]})}),x("article",{className:"success",children:R("details",{children:[x("summary",{children:"Success"}),R("p",{children:["Operation finished ",x("code",{children:"OK"})]})]})}),x("article",{className:"error",children:R("details",{children:[x("summary",{children:"Error"}),R("div",{children:[x("p",{children:"Unknown error occurred"}),x("hr",{}),x("button",{children:"Acknowledge"})]})]})}),x("p",{children:R("small",{children:["You can learn more about colors ",x("a",{href:r.doc("colors",e,o),children:"here"})," and cards ",x("a",{href:r.doc("cards",e,o),children:"here"}),"."]})})]}),x("div",{children:x(t,{lang:"xml",children:`<article>
  <details>
...
</article>`})})]}),R("section",{className:"row",children:[R("div",{children:[R("p",{children:["Finally, by giving a group of summary elements the same name and placing them inside an ",x("code",{children:"article"}),", you can form an accordion menu:"]}),R("article",{children:[R("details",{name:"menu",children:[x("summary",{children:"Option 1"}),x("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."})]}),R("details",{name:"menu",open:!0,children:[x("summary",{children:"Option 2"}),x("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."})]}),R("details",{name:"menu",children:[x("summary",{children:"Option 3"}),x("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."})]})]})]}),x("div",{children:x(t,{lang:"xml",children:`
<article>
  <details name="menu">
...
<mark class="error">
...
</form>`})})]}),K("section",{className:"row",children:[K("div",{children:[S("p",{children:"If you want only one item to be selected out of a list of multiple options, you can use radio inputs."}),K("form",{children:[S("p",{children:S("b",{children:"Wrapping"})}),K("label",{htmlFor:"bread",children:[S("input",{type:"radio",id:"bread",name:"radio",value:"bread",checked:o==="bread",onChange:B=>a(B.target.value)}),S("span",{children:"Bread"})]}),K("label",{htmlFor:"salad",children:[S("input",{type:"radio",id:"salad",name:"radio",value:"salad",checked:o==="salad",onChange:B=>a(B.target.value)}),S("span",{children:"Salad"})]})]})]}),S("div",{children:S(t,{lang:"xml",children:`<form>
  <div className="row">
    <p><b>Wrapping</b></p>
...
</form>`})})]})})}import{jsx as $,jsxs as z}from"https://esm.sh/react@19.2.0/jsx-runtime";function Oe({theme:e}){return z(c,{theme:e,children:[z("section",{className:"row",children:[z("div",{children:[z("p",{children:["Simple forms, with a small number of inputs, can be grouped horizontally by applying the ",$("code",{children:"group"})," role to a parent tag. In such a case, auxiliary elemnents such as input labels should not be used."]}),$("form",{children:z("div",{role:"group",children:[$("input",{id:"email",type:"email",placeholder:"Email"}),$("input",{type:"submit",value:"Subscribe"})]})})]}),$("div",{children:$(t,{lang:"xml",children:`<form>
  <div role="group">
    <input 
      id="email" 
      type="email" 
...
</form>`})})]}),z("section",{className:"row",children:[z("div",{children:[z("p",{children:["You can still wrap form elements inside a ",$("code",{children:"fieldset"})," with an appropriate ",$("code",{children:"legend"})," tag."]}),$("form",{children:z("fieldset",{children:[$("legend",{children:"Selection"}),z("div",{role:"group",children:[z("select",{id:"delivery",defaultValue:"fast",children:[$("option",{value:"fast",children:"Fast"}),$("option",{value:"standard",children:"Standard"})]}),$("input",{type:"date",id:"delivery-date"}),$("input",{type:"submit",value:"Confirm"})]})]})})]}),$("div",{children:$(t,{lang:"xml",children:`<form>
  <fieldset>
    <legend>
      Selection
    </legend>
...
</form>`})})]}),z("section",{className:"row",children:[z("div",{children:[$("p",{children:"And you can group checkbox and radio in order to display them horizontally as well."}),$("form",{children:z("div",{role:"group",children:[z("label",{htmlFor:"ch_1",children:[$("input",{type:"checkbox",id:"ch_1",name:"check",value:"ch_1"}),$("span",{children:"Check #1"})]}),z("label",{htmlFor:"ch_2",children:[$("input",{type:"checkbox",id:"ch_2",name:"check",value:"ch_2"}),$("span",{children:"Check #2"})]}),z("label",{htmlFor:"ch_3",children:[$("input",{type:"checkbox",id:"ch_3",name:"check",value:"ch_3"}),$("span",{children:"Check #3"})]})]})})]}),$("div",{children:$(t,{lang:"xml",children:`<form>
  <div role="group">
    <label for="ch_1">
      <input 
        type="checkbox" 
    ...
    ...
</form>`})})]})]})}import{useState as Ht}from"https://esm.sh/react@19.2.0";import{jsx as u,jsxs as q}from"https://esm.sh/react@19.2.0/jsx-runtime";function Ge({theme:e}){let o=D(),[a,B]=Ht(50);return q(c,{theme:e,children:[q("section",{className:"row",children:[q("div",{children:[q("p",{children:["All ",u("a",{href:"https://www.w3schools.com/html/html_forms.asp",target:"_blank",children:"HTML form elements"})," are supported and can be easily arranged into a pleasantly looking and functional form. There is no JavaScript required and no extra CSS."]}),q("form",{children:[q("label",{htmlFor:"email",children:[u("span",{children:"Email"}),u("input",{type:"email",placeholder:"Email Address",id:"email"})]}),q("label",{htmlFor:"password",children:[u("span",{children:"Password"}),u("input",{type:"password",id:"password",placeholder:"Password"})]}),u("input",{type:"submit",value:"Login"}),q("p",{children:["Don't have an account? ",u("a",{href:"",children:"Sign up"}),"."]})]})]}),u("div",{children:u(t,{lang:"xml",children:`<form>
  <fieldset>
    <legend>
      Login
    </legend>
...
</form>`})})]}),q("section",{className:"row",children:[q("div",{children:[u("p",{children:"Textareas are supported as well and by default they expand to fit the available horizontal space."}),q("form",{children:[u("textarea",{rows:4,id:"textarea",placeholder:"Write your comments..."}),u("input",{type:"submit",value:"Comment"})]})]}),u("div",{children:u(t,{lang:"xml",children:`<form>
  <textarea 
    rows="4" 
    id="textarea" 
    name="textarea"
  ...
  <input 
    type="submit" 
    value="Comment"/>
</form>`})})]}),q("section",{className:"row",children:[q("div",{children:[u("p",{children:"Ranged inputs are also supported."}),q("form",{children:[q("label",{htmlFor:"volume",children:[u("span",{children:"Volume (range)"}),u("input",{type:"range",id:"volume",name:"volume",min:0,max:100,step:1,value:a,onChange:p=>B(Number(p.target.value))})]}),u("input",{type:"submit",value:"Tune"})]})]}),u("div",{children:u(t,{lang:"xml",children:`<form>
  <label for="volume">
    <span>
      Volume (range)
    </span>
  ...
  <input 
    type="submit" 
    value="Tune"/>
</form>`})})]}),u("section",{children:q("div",{className:"row",children:[q("div",{children:[q("p",{children:["If you want your forms to stand out more, you can wrap the inputs inside a ",u("code",{children:"fieldset"})," and assign a ",u("code",{children:"legend"}),"."]}),u("form",{children:q("fieldset",{children:[u("legend",{children:"Details"}),q("div",{className:"row disable-mobile",children:[u("div",{children:q("label",{htmlFor:"first-name",children:[u("span",{children:"First name"}),u("input",{type:"text",id:"first-name",placeholder:"First name"})]})}),u("div",{children:q("label",{htmlFor:"last-name",children:[u("span",{children:"Last name"}),u("input",{type:"text",id:"last-name",placeholder:"Last name"})]})})]}),q("div",{className:"row disable-mobile",children:[u("div",{children:q("label",{htmlFor:"delivery",children:[u("span",{children:"Delivery Time"}),q("select",{id:"delivery",defaultValue:"mornibgt",children:[u("option",{value:"morning",children:"Morning"}),u("option",{value:"evening",children:"Evening"})]})]})}),u("div",{children:q("label",{htmlFor:"delivery-date",children:[u("span",{children:"Delivery Date"}),u("input",{type:"date",id:"delivery-date"})]})})]}),q("blockquote",{className:"success",children:["Order total is ",u("b",{children:"$33.59"})]}),q("div",{className:"row disable-mobile",children:[u("div",{children:u("input",{type:"reset",className:"error",value:"Reset"})}),u("div",{}),u("div",{children:u("input",{type:"submit",value:"Confirm"})})]})]})}),u("p",{children:"You can make forms as simple or as complex as you want."}),q("p",{children:["In the example above we're separating inputs into two separate ",u("a",{href:r.doc("grid",e,o),children:"columns"}),", so we can pack more information in the same space."]}),q("p",{children:["We're also using ",u("a",{href:r.doc("blockquotes",e,o),children:"blockquotes"})," to highlight important information."]}),q("p",{children:["We're using both ",u("code",{children:"submit"})," and ",u("code",{children:"reset"})," type inputs. Please note these inputs are styled to look exactly like ",u("a",{href:r.doc("blockquotes",e,o),children:"buttons"}),"."]})]}),u("div",{children:u(t,{lang:"xml",children:`<form>
  <fieldset>
    <legend>
      Order details
    </legend>
...
</form>`})})]})})]})}import{useState as lt}from"https://esm.sh/react@19.2.0";import{jsx as T,jsxs as X}from"https://esm.sh/react@19.2.0/jsx-runtime";function ze({theme:e}){let[o,a]=lt("a"),[B,p]=lt(""),[h,le]=lt("");return X(c,{theme:e,children:[X("section",{className:"row",children:[X("div",{children:[X("p",{children:["Helper styles for form validation come out of the box for any ",T("code",{children:"input"})," and ",T("code",{children:"textarea"})," elements marked as ",T("b",{children:"required"}),"."]}),T("p",{children:"Error styles apply to an input if either they start out as invalid or if the user types something, switches focus, and leaves the input invalid."}),T("p",{children:"Empty inputs do not display error styles."}),X("p",{children:["Adjacent text elements with the ",T("code",{children:"error"})," class can also have error styles applied, so as to act as guides for the user."]}),T("form",{action:"",method:"post",children:X("fieldset",{children:[T("legend",{children:"Input"}),X("label",{htmlFor:"name",children:[T("span",{children:"Name"}),T("input",{id:"name",name:"name",required:!0,placeholder:"Name...",pattern:".{4,100}",title:"Name must be at least 4 characters",value:o,onChange:ue=>a(ue.target.value)}),T("span",{className:"error",children:T("small",{children:"Enter a name between 4 and 100 characters"})})]}),X("label",{htmlFor:"email",children:[T("span",{children:"Email"}),T("input",{id:"email",name:"email",type:"email",required:!0,placeholder:"Email...",value:B,onChange:ue=>p(ue.target.value)})]}),X("label",{htmlFor:"comment",children:[T("span",{children:"Comment"}),T("textarea",{rows:5,id:"comment",name:"comment",placeholder:"Enter your comment",required:!0,minLength:10,maxLength:500,value:h,onChange:ue=>le(ue.target.value)}),T("span",{className:"error",children:T("small",{children:"Enter a meaningful comment"})})]}),T("input",{type:"submit",value:"Submit"})]})})]}),T("div",{children:T(t,{lang:"xml",children:`<form action="/" method="post">
  <fieldset>
    <legend>
      Input
    </legend>
...
</form>`})})]}),X("section",{className:"row",children:[X("div",{children:[X("p",{children:["Inputs that present a more limited range of options to a user, such as ",T("code",{children:"select"}),", ",T("code",{children:"radio"})," and ",T("code",{children:"check"})," buttons, won't display a error styles but can be set as required."]}),T("form",{children:X("fieldset",{children:[T("legend",{children:"Countries"}),X("select",{id:"country",name:"country",required:!0,children:[T("option",{value:"",disabled:!0,selected:!0,hidden:!0,children:"Please select a country"}),T("option",{value:"uk",children:"United Kingdom"}),T("option",{value:"fr",children:"France"}),T("option",{value:"de",children:"Germany"})]}),X("label",{children:[T("input",{type:"checkbox",name:"terms",required:!0}),"I accept the terms and conditions"]}),T("input",{type:"submit",value:"Submit"})]})})]}),T("div",{children:T(t,{lang:"xml",children:`<form>
  <fieldset>
    <legend>
      Countries
    </legent>
...
</form>`})})]})]})}import{useRef as It}from"https://esm.sh/react@19.2.0";import{jsx as ee,jsxs as Ye}from"https://esm.sh/react@19.2.0/jsx-runtime";function Pe({theme:e}){let o=It(null);return ee(c,{theme:e,children:Ye("section",{className:"row",children:[Ye("div",{children:[ee("p",{children:"Native browser dialogs are supported out of the box and are styled as modals. Child elements are styled the same as any other element."}),ee("p",{children:"Click the button below to open the modal dialog."}),ee("p",{children:ee("button",{onClick:()=>o.current?.showModal(),children:"Open modal"})}),ee(At,{ref:o})]}),ee("div",{children:ee(t,{lang:"xml",children:`<button id="openBtn">Open modal</button>
...
</div>`})})]})]})}import{jsx as E,jsxs as W}from"https://esm.sh/react@19.2.0/jsx-runtime";function Ze({theme:e}){let o=D();return W(c,{theme:e,children:[W("section",{className:"row",children:[W("div",{children:[E("p",{children:"The CSS framework is design to handle various screen sizes, from wide (desktop) to narrow (mobile)."}),W("p",{children:["The threshold between wide and narrow happens at ",E("b",{children:"600px"}),"."]}),E("p",{children:"Most elements, like paragraphs of text, buttons, etc, will layout or cascade naturally."}),W("figure",{children:[E("iframe",{scrolling:"no",width:"100%",height:300,src:r.example("mobile-typography",e,o)}),W("figcaption",{children:["More information ",E("a",{href:r.doc("typography",e,o),children:"here"})]})]})]}),E("div",{children:E(t,{lang:"xml",children:`<!-- elements that -->
<!-- resize naturally -->
<!-- on mobile -->
<p>
  Lorem ipsum ....
</p>`})})]}),W("section",{className:"row",children:[W("div",{children:[E("p",{children:"Navigation elements are one example where there's a distinct transition between wide and narrow displays. In wide displays they're arranged horizontally whist in narrow displays they're aranged vertically, to conserve space."}),W("figure",{children:[E("iframe",{scrolling:"no",width:"100%",height:300,src:r.example("mobile-nav",e,o)}),W("figcaption",{children:["More information ",E("a",{href:r.doc("navigation",e,o),children:"here"})," or ",E("a",{href:r.doc("tabs",e,o),children:"here"}),"."]})]})]}),E("div",{children:E(t,{lang:"xml",children:`<header>
  <nav>
    <ul>
      <li><a ...>...</a></li>
      ....
...
</header>`})})]}),W("section",{className:"row",children:[W("div",{children:[E("p",{children:"Header menu elements are another example. On wide displays they are arrange horizontally, at the top of the page. On narrow displays they still maintain the horizontal arrangement, but are displayed at the bottom of the page, to simulate mobile app displays."}),W("figure",{children:[E("iframe",{scrolling:"no",width:"100%",height:300,src:r.example("mobile-menu",e,o)}),W("figcaption",{children:["More information ",E("a",{href:r.doc("menu",e,o),children:"here"}),"."]})]})]}),E("div",{children:E(t,{lang:"xml",children:`<header>
  <menu>
    <li><a ...>...</a></li>
    ....
  </menu>
</header>`})})]}),W("section",{className:"row",children:[W("div",{children:[W("p",{children:["Finally, elements that have the ",E("code",{children:"row"})," class also behave differentely. In wide displats, they're arrange horizontally, with a gap between them. In narrow displays the flip to a vertical arrangement, with no gap between them."]}),W("figure",{children:[E("iframe",{scrolling:"no",width:"100%",height:300,src:r.example("mobile-columns",e,o)}),W("figcaption",{children:["More information ",E("a",{href:r.doc("grid",e,o),children:"here"}),"."]})]})]}),E("div",{children:E(t,{lang:"xml",children:`<div class="row">
  <div class="col">...</div>
  <div class="col">...</div>
</div>`})})]}),W("section",{className:"row",children:[W("div",{children:[W("p",{children:["You can instruct an element to ignore mobile transitions by applying the ",E("code",{children:"disable-mobile"})," class."]}),W("p",{children:["You can also instruct elements to be hidden on mobile, via the ",E("code",{children:"hiden-on-mobile"})," class, or be hidden on desktop, via the ",E("code",{children:"hiden-on-desktop"})," class."]})]}),E("div",{})]})]})}import{jsx as l,jsxs as M}from"https://esm.sh/react@19.2.0/jsx-runtime";function Je({theme:e}){let o=D();return M(c,{theme:e,children:[M("section",{className:"row",children:[M("div",{children:[M("p",{children:["By wrapping together a number of HTML elements inside an ",l("code",{children:"article"}),", you can create a basic card-type layout."]}),M("div",{className:"row disable-mobile",children:[l("div",{children:M("article",{children:[l("span",{children:l("b",{children:"Title"})}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})}),l("div",{children:M("article",{className:"success",children:[l("span",{children:l("b",{children:"Title"})}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})})]})]}),l("div",{children:l(t,{lang:"xml",children:`<article>
  <span>
    <b>Title</b>
  </span>
  <p>
...
</article>`})})]}),M("section",{className:"row",children:[M("div",{children:[M("p",{children:["Cards can wrap headings and paragraphs and can be styled with ",l("code",{children:"success"})," and ",l("code",{children:"error"})," classes."]}),M("div",{className:"row disable-mobile",children:[l("div",{children:M("article",{children:[l("h3",{children:"Title"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})}),l("div",{children:M("article",{className:"error",children:[l("h3",{children:"Title"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})})]}),l("p",{children:M("small",{children:["You can learn more about classes ",l("a",{href:r.doc("classes",e,o),children:"here"}),"."]})})]}),l("div",{children:l(t,{lang:"xml",children:`<article>
  <h3>Title</h3>
  <p>
    Lorem ipsum ...
  </p>
</article>`})})]}),M("section",{className:"row",children:[M("div",{children:[M("p",{children:["The ",l("code",{children:"header"})," element of a card will be styled so it's more proeminent."]}),M("div",{className:"row disable-mobile",children:[l("div",{children:M("article",{children:[l("header",{children:"Title"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})}),l("div",{children:M("article",{className:"success",children:[l("header",{children:"Title"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})})]})]}),l("div",{children:l(t,{lang:"xml",children:`<article>
  <header>Title</header>
  <p>
    Lorem ipsum ...
  </p>
</article>`})})]}),M("section",{className:"row",children:[M("div",{children:[l("p",{children:"Likewise, the first image tag used in a card will be styled as a header image."}),M("div",{className:"row disable-mobile",children:[l("div",{children:M("article",{children:[l("img",{height:"80",src:"https://picsum.photos/id/16/320/80",alt:"header image"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})}),l("div",{children:M("article",{className:"error",children:[l("img",{height:"80",src:"https://picsum.photos/id/16/420/80",alt:"header image"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit."})]})})]})]}),l("div",{children:l(t,{lang:"xml",children:`<article>
  <img 
    height="80" 
    src="..." 
    alt="..." />
...
</article>`})})]}),M("section",{className:"row",children:[M("div",{children:[l("p",{children:"You can combine elements inside a card to produce quite compelx results, as the example below shows."}),l("p",{children:"By adding a header image, a title, paragraph and a button, we've created an interesting visual element in a few lines of HTML."}),M("article",{children:[l("img",{height:"160",src:"https://picsum.photos/id/16/480/160",alt:"header image"}),l("h4",{children:"Title"}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}),l("p",{children:l("button",{children:"Button"})})]})]}),l("div",{children:l(t,{lang:"xml",children:`<article>
  <img 
    height="160" 
    src="..." 
    alt="..." />
...
</article>`})})]}),M("section",{className:"row",children:[M("div",{children:[l("p",{children:"If we combine groups, columns and cards, we can experiment with even more daring layouts all while using just semantic HTML and minimal classes."}),M("article",{children:[l("div",{role:"group",children:M("div",{className:"row",children:[l("img",{width:"80",height:"80",src:"https://picsum.photos/id/16/80/80",alt:"header image"}),M("div",{children:[l("b",{children:"Title"}),l("br",{}),l("span",{children:"Subtitle"})]})]})}),l("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}),M("p",{children:[l("mark",{children:"v12.5.3"}),l("mark",{className:"success",children:"success"})]}),l("hr",{}),l("p",{children:l("button",{children:"Button"})})]}),l("p",{children:M("small",{children:["You can learn more about groups ",l("a",{href:r.doc("groups",e,o),children:"here"}),"."]})}),l("p",{children:M("small",{children:["You can learn more about columns ",l("a",{href:r.doc("grid",e,o),children:"here"}),"."]})})]}),l("div",{children:l(t,{lang:"xml",children:`<article>
  <div role="group">
    <div class="row">
      <img 
        width="80" 
...
<div class="row">
  ...
  <div>...</div>
</div>`})})]})]})}import{jsx as Y,jsxs as xe}from"https://esm.sh/react@19.2.0/jsx-runtime";function et({theme:e}){return Y(c,{theme:e,children:xe("section",{className:"row",children:[xe("div",{children:[Y("p",{children:"There are three classes that allow you to set different content widths:"}),xe("table",{children:[Y("thead",{children:xe("tr",{children:[Y("th",{children:"Class"}),Y("th",{children:"Width"}),Y("th",{children:"Info"})]})}),xe("tbody",{children:[xe("tr",{children:[Y("td",{children:Y("code",{children:"container-narrow"})}),Y("td",{children:"800px"}),Y("td",{children:"This is the default viewport. Suitable for blogs, newsletters, etc."})]}),xe("tr",{children:[Y("td",{children:Y("code",{children:"container-medium"})}),Y("td",{children:"1200px"}),Y("td",{children:"A slighlty larger viewport that allows more content on the screen whilst at the same time still centering it."})]}),xe("tr",{children:[Y("td",{children:Y("code",{children:"container-wide"})}),Y("td",{children:"1600px"}),Y("td",{children:"The largest viewport. Suitable for apps, dashboard, etc."})]})]})]}),Y("p",{children:"Of course, on mobile devices or tables, the viewport will adjust accordingly."})]}),Y("div",{children:Y(t,{lang:"xml",children:`<header class="container-medium">
  <nav>
    ....
  </nav>
</header>
...
<footer class="container-medium">
 ...
</footer>`})})]})})}import{jsx as F,jsxs as V}from"https://esm.sh/react@19.2.0/jsx-runtime";function tt({theme:e}){return V(c,{theme:e,children:[V("section",{className:"row",children:[V("div",{children:[V("p",{children:["Some elements are visually meant to ",F("q",{children:"stick"})," together. In such a case, you can wrap them in a parent that's been given the ",F("code",{children:"group"})," role."]}),V("p",{children:["In the case of a group of ",F("code",{children:"buttons"}),", all horizontal spacing and borders between them dissapear."]}),V("p",{role:"group",children:[F("button",{children:"Option 1"}),F("button",{type:"reset",children:"Option 2"})]})]}),F("div",{children:F(t,{lang:"xml",children:`<p role="group">
  <button>
    Option 1
  </button>f
  <button type="reset">
...
</p>`})})]}),V("section",{className:"row",children:[V("div",{children:[V("p",{children:["In the case of a group of ",F("code",{children:"marks"}),", they're also pulled together and have any vertical space dissapear."]}),V("p",{role:"group",children:[F("mark",{children:"#test"}),F("mark",{className:"success",children:"v1.0.0"})]})]}),F("div",{children:F(t,{lang:"xml",children:`<p role="group">
  <mark>
    #test
  </mark>
  <mark 
...
</p>`})})]}),V("section",{className:"row",children:[V("div",{children:[F("p",{children:"Grouping elements really shines in the case of forms and form inputs. You can see below an example of a compact login form."}),F("form",{children:V("div",{role:"group",children:[F("input",{id:"email",type:"email",placeholder:"Email"}),F("input",{id:"password",type:"password",placeholder:"Password"}),F("input",{type:"submit",value:"Login"})]})})]}),F("div",{children:F(t,{lang:"xml",children:`<form>
  <div role="group">
    <input 
      id="email" 
      type="email" 
...
</div>`})})]}),V("section",{className:"row",children:[V("div",{children:[F("p",{children:"Other elements, such as images, can also be grouped, although the impact isn't as pronounced."}),V("p",{role:"group",children:[F("img",{width:"80",height:"80",src:"https://picsum.photos/id/16/80/80",alt:"image 1"}),F("img",{width:"80",height:"80",src:"https://picsum.photos/id/16/120/120",alt:"image 2"})]})]}),F("div",{children:F(t,{lang:"xml",children:`<p role="group">
  <img 
    width="80" 
    height="80" 
    src="..." 
...
`})})]})})}import{jsx as Le,jsxs as Me}from"https://esm.sh/react@19.2.0/jsx-runtime";function rt({theme:e}){let o=D();return Me(c,{theme:e,children:[Me("section",{className:"row",children:[Me("div",{children:[Me("p",{children:["A ",Le("code",{children:"footer"})," element is used to define the very last piece of content in a page or a section. The simplest footer can contain text, links, etc."]}),Le("iframe",{scrolling:"no",width:"100%",height:500,src:r.example("layout-footer-simple",e,o)})]}),Le("div",{children:Le(t,{lang:"xml",children:`<footer>
  <div>
    This is a simple footer
    with a <a href="...">link</a>.
  </div>
</footer>`})})]}),Me("section",{className:"row",children:[Me("div",{children:[Le("p",{children:"More complex footers can contain information divided by columns, etc."}),Le("iframe",{scrolling:"no",width:"100%",height:500,src:r.example("layout-footer-complex",e,o)})]}),Le("div",{children:Le(t,{lang:"xml",children:`<footer>
  <div>
    <div class="row">
      <div>
        <nav>
